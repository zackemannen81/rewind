...
- **Acceptance Criteria:**
  ...
  - The drone patrol and all interactive elements are scripted.
  - The first Causality Anchor (unlocking the courtyard gate) is implemented.
  - All narrative triggers and radio messages are in place.
- **Dependencies:** SYS-001, PC-001, ART-001, SND-001
